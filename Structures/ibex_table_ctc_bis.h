...
public:
	CtcTable(const System& sys, const std::vector<std::pair<std::string, std::vector<double>>>& M, const std::vector<std::string>& vars);
	CtcTable(const std::vector<std::pair<std::string, std::vector<double>>>& M, const std::vector<int>& idx);

	CtcTable(const std::vector<std::pair<std::string, std::vector<double>>>& M, const BitSet& bst);
...
protected:
	...
	const std::vector<std::pair<std::string, std::vector<double>>> values; // table of acceptable values
...
inline CtcTable::CtcTable(const System& sys, const std::vector<std::pair<std::string, std::vector<double>>>& M, const std::vector<std::string>& vars)
...
inline CtcTable::CtcTable(const std::vector<std::pair<std::string, std::vector<double>>>& M, const std::vector<int>& idx)
: Ctc(idx.size()), values(M), var_indices(idx){
	assert(var_indices.size() == M.nb_rows());
}

inline CtcTable::CtcTable(const std::vector<std::pair<std::string, std::vector<double>>>& M, const BitSet& bst)
